...
const MapBottomSheet = React.lazy(() => import("@/components/coffeechat/MapBottomSheet"));
const JoinCoffeeChatModal = React.lazy(() => import('@/components/coffeechat/JoinCoffeeChatModal'));
