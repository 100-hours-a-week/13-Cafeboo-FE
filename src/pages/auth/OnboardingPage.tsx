...
const OnboardingPage = () => {
  ...
  const validateStep = () => {
    ...
    switch (step) {
      case 1: 
        ...
        if (!healthInfo.height || healthInfo.height < 62 || healthInfo.height > 251) {
          setErrorMessage("올바른 신장을 입력해주세요.");
          return false;
        }
        if (!healthInfo.weight || healthInfo.weight < 6.5 || healthInfo.weight > 635) {
          setErrorMessage("올바른 체중을 입력해주세요.");
          return false;
        }
        return true;
      case 2: 
        if (caffeineInfo.averageDailyCaffeineIntake === undefined || caffeineInfo.averageDailyCaffeineIntake < 0 || caffeineInfo.averageDailyCaffeineIntake > 15) {
  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return <form name="step1Form"><Step1 /></form>;
      case 2:
        return <form name="step2Form"><Step2 /></form>;
      case 3:
        return <form name="step3Form"><Step3 /></form>;
      case 4:
        return <form name="step4Form"><Step4 /></form>;
      default:
        return null;
    }
  };
