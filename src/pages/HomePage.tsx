  ...
  return (
    <div className="dark:bg-[#121212] min-h-screen">
      ...
      <main className="pt-14 space-y-4">
        {/* Hero Banner */}
        <div className="relative w-full rounded-xl overflow-hidden bg-black dark:bg-[#2C2C2C] shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
          <HeroBanner slides={slides} />
        </div>


        {/* 일일 섭취량 카드 */}
        <div className="bg-white dark:bg-[#2C2C2C] rounded-xl shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
        ...
        {/* 시간대별 잔여량 카드 */}
        <div className="bg-white dark:bg-[#2C2C2C] rounded-xl pl-2 pr-2 pt-2 shadow-[0_4px_10px_rgba(0,0,0,0.15)]">
          <DailyCaffeineRemain
        ...
        {/* 카페인 추가 버튼 */}
        <button
          className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-[#543122] text-white flex items-center justify-center shadow-[0_6px_20px_rgba(0,0,0,0.5)]"
