...
const SignupForm = ({
  ...
  return (
    ...
    >
      <h1 className="text-center text-[26px] font-bold text-[#543122] mt-12 mb-8">
        CafeBoo
      </h1>

      {/* 닉네임 */}
      <div>
        <label className="text-base font-semibold text-[#56433C] block mb-2">
          닉네임
        </label>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={() =>
              handleNicknameCheck(
                (document.querySelector('[name=nickname]') as HTMLInputElement)
                  ?.value
              )
            }
      ...
      <div>
        ...
        <div className="relative">
          ...
          />
          <div
            className="absolute top-1/2 right-3 transform -translate-y-1/2 text-[#C7C7CC] cursor-pointer"
