  ...
  return (
    <form onSubmit={handleSubmit(onLogin)} className="space-y-4 w-full max-w-xs mx-auto">
      ...
      <input
        ...
        placeholder="아이디"
        {...register('email')}
        className="w-full py-2 px-4 rounded-lg border text-base text-[#56433C] bg-[#FFFFFF] border-[#C7B39C] focus:outline-none focus:ring-1 focus:ring-[#97694E]"
      />
      {errors.email && (
      ...
      <button
        type="submit"
        className="w-full py-2 rounded-lg bg-[#97694E] text-[#FEFBF8] font-semibold mt-2"
      >
        로그인
      </button>
    </form>
